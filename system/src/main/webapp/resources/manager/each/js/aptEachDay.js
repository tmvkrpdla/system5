...
$(function(){
	...
	$("#searchBtn").on('click', function(){
		...
		var sdd = document.getElementById("dateFrom").value;
		var edd = document.getElementById("dateTo").value;
		var ar1 = sdd.split('-');
		var ar2 = edd.split('-');
		...
		var datelong = parseInt(dif / cDay);
	//	console.log("datelong = ", datelong);
		...
		if (datelong > 32) {
			return alert("최대 조회 가능 기간은 31일 입니다.")
		}
