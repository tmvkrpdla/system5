...
//	}
	...
	function saveBtn() {
		...
		// 여기부터 연습~
		var ctrSeqHo = document.createElement("input");
		ctrSeqHo.setAttribute("id", "ctrSeqHo");
		ctrSeqHo.setAttribute("class", "ctrSeqHo");
		ctrSeqHo.setAttribute("name", "ctrSeqHo");
		ctrSeqHo.setAttribute("type", "text");
		ctrSeqHo.setAttribute("value", str1);
		document.body.appendChild(ctrSeqHo);
