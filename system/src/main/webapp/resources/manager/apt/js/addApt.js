...
//						console.log("_naverInfo = " + _naverInfo);
...
//							alert("_pyeongHoList = " + _pyeongHoList);
						...
						let _saveState = document.getElementsByName('saveState');
						let _saveBtnIdx = $(".saveBtnIdx").val();
						let naverReplyBtn = document.getElementsByClassName('naverReply');
						let _reply = document.getElementsByName('reply');

						var str1 = tdArr.join();
						console.log("str1 = " + str1);

						dongName2Box[_saveBtnIdx].value = _dongName;
						console.log("_dongName = " + _dongName);
						str1Box[_saveBtnIdx].value = str1;
						_saveState[_saveBtnIdx].value = "입력완료";
						naverReplyBtn[_saveBtnIdx].value = "재입력";
						naverReplyBtn[_saveBtnIdx].className += ' reNaverEnter';
						
//						document.getElementsByName('reply')[_saveBtnIdx].toggle();
							
//						$(this).closest("input[name='reply']").toggle(); 이거 안 먹음
						$(this).parents('tr.saveDongEvt').find("input[name='reply']").toggle();
