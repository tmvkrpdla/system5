									...
									<div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4">
										...
										<div class="row">
											<div class="col-sm-12">
												...
												<table class="table tablesorter" id="dataTable" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 50%;">
													<tr>
														<th scope="row"><h5 style="margin:0;">협력 업체</h5></th>
													...
													<tr>
														<th scope="row"><h5 style="margin:0;">이름</h5></th>
														<td><input type="text" class="join-input" id="w_name" name="w_name" required></td>
													</tr>	
													<tr>
														<th scope="row"><h5 style="margin:0;">아이디</h5></th>
													...
													<tr>
														<th scope="row"><h5 style="margin:0;">비밀번호</h5></th>
...
<!-- 																일치하지 않습니다.</div></td> -->
													...
													<tr>
														<th scope="row"><div class="mail_name"><h5 style="margin:0;">이메일</h5></div></th>
														<td><div class="mail_input_box">
																<input name="w_email" id="w_email"></div></td>
													</tr>
													<tr>
														<th scope="row"><h5 style="margin:0;">연락처</h5></th>
