...
<c:if test="${not empty sessionScope}">
	<script src="${pageContext.request.contextPath}/resources/manager/apt/js/testLGJ.js"></script>
</c:if>
							...
							<div class="card-body">
								<div class="table-responsive" style="overflow: hidden;">
									<div id="dataTable_wrapper"
										...
										<form id="addAptForm" name="addAptForm" method='POST' action="<c:url value='../apt/testLGJ2'/>">
											<input type="hidden" id="nowPage" name="nowPage" value="${nowPage}" readonly>
											<c:forEach items="${list_site_forindex}" var="list_site_forindex">
												<input class="siteName" name="siteName" type="hidden" value="${list_site_forindex.site_name}">
											</c:forEach>
										</form>
										<div class="row">
											<div class="col-sm-12">
													...
													<ul class="pagination">
														...
														<c:if test="${PAGEUTIL.startPage ne 1}">
															<li class="paginate_button page-item previous" id="">
																<a
																href="../apt/estate?nowPage=${PAGEUTIL.startPage - 1 }"
														...
														<c:if test="${PAGEUTIL.totalCount eq 0}">
															<li class="paginate_button page-item" id=""><a
																href="../apt/estate?nowPage=1" aria-controls="dataTable"
														...
														<c:if test="${PAGEUTIL.endPage ne PAGEUTIL.totalPage}">
															<li class="paginate_button page-item next"
																id="dataTable_previous"><a href="../apt/estate?nowPage=${PAGEUTIL.endPage+1}" class="page-link"> > </a></li>
														</c:if>
													</ul>
												</div>
											</div>
