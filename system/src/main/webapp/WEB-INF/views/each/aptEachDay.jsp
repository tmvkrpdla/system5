...
<script src="${pageContext.request.contextPath}/resources/manager/each/js/aptEachDay.js"></script>
...
<div class="container1 column board">
	<div class="row pd1_5_lr">
		...
		<div class="page_heading">
			<div class="location">
				<button type="button" class="home" onclick="location.href = '<c:url value='/dashboard/energyDashboard.do'/>' ">
					<img src="<c:url value="/resources/images/common/ic_home.svg"/>" alt="홈">
				</button>
				<a href="<c:url value='/manage/memList.do'/>">날짜별 사용량</a> <span>날짜별 사용량</span>
			</div>
			<h2 class="title">날짜별 사용량</h2>
		</div>
	</div>
		...
		<div id="community_wrap" class="tab_container ">
			...
			<div class="tab_wrap">
				...
				<div class="top_right_wrap mt-em3">
					<div class="btn_fix">
						<button class="btn normal bgreen down" onclick="excelDown();" type="button" title="엑셀 다운받기">엑셀 다운받기</button>
					</div>
				</div>
				<!-- //.end 상단 우측 영역 -->
						...
						<div class="card-body">
							<div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4">
								<div style="width: 100%; display: inline-block;" class="col-sm-6-hs">
									...
									<form id="searchForm" name="searchForm" method="post" action="<c:url value='../each/eachDay.do'/>">
								
									<div style="width: 200px; float: left;">
										<input class="custom-date custom-date-sm" id="dateFrom"
											name="dateFrom" type="text" style="width: 95%; background: #182241; color: #dfdfdf;" value="${DATEFROM}">
									</div>
									...
									<div style="width: 200px; float: left;">
										<input class="custom-date custom-date-sm" id="dateTo"
											name="dateTo" type="text" style="width: 95%; background: #182241; color: #dfdfdf;" value="${DATETO}">
									</div>
								...
								<div style="width: 100%; display: inline-block;">
									<div style="width: 100px; float: left;">
										<span style="display: inline-block; height: 21px;"></span>단지 선택
									</div>
									...
									<!-- 동 호 선택  -->
									<div style="width: 200px; float: left;">
										<select id="aptDongSelect" name="seq_apt_dong" class="custom-select custom-date-sm" style="width: 120px;">
									...
									<div style="width: 200px; float: left;">
										<select id="aptHoSelect" name="seq_apt_ho" class="custom-select custom-date-sm" style="width: 120px;">
...
<c:forEach var="LIST_USAGE" items="${LIST_USAGE}">
	...
	var _unitDate = ${LIST_USAGE.cptr_date};
	
	var _year = String(_unitDate).substring(0,4);
	var _month = String(_unitDate).substring(4,6);
	var _day = String(_unitDate).substring(6,8);
	
	_chartLabels.push(_month.replace(/(^0+)/, "") + "/" + _day.replace(/(^0+)/, ""));
